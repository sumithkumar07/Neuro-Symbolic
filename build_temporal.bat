...
call "%VCVARS%" x64
echo Compiling Sovereign_Temporal_Hybrid.cpp...
cl.exe /std:c++17 /EHsc /O2 Sovereign_Temporal_Hybrid.cpp
if %errorlevel% neq 0 (
    echo Compilation failed.
    exit /b %errorlevel%
)
echo.
echo === RUNNING PHASE 12 TEMPORAL ===
Sovereign_Temporal_Hybrid.exe
