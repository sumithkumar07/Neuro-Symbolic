...
call "%VCVARS%" x64
echo Compiling Sovereign_Sharded_Hybrid.cpp...
cl.exe /std:c++17 /EHsc /O2 Sovereign_Sharded_Hybrid.cpp
if %errorlevel% neq 0 (
    echo Compilation failed.
    exit /b %errorlevel%
)
echo.
echo === RUNNING PHASE 11 SHARDED ===
Sovereign_Sharded_Hybrid.exe
